				...
				while (eventType != XmlPullParser.END_DOCUMENT) {
					...
					case XmlPullParser.START_TAG:
						...
						if (tag.equals("atmosphere")) {
							curHumidity = xpp.getAttributeValue(null,
									"humidity");
						}
						...
						if (tag.equals("forecast")) {
							if (count == 0) {
								...
								todayCondition = xpp.getAttributeValue(null,
										"text");
								todayConditionCode = xpp.getAttributeValue(
										null, "code");
							} else if (count == 1) {
								tomorrowDay = xpp
										.getAttributeValue(null, "day");
								tomorrowDate = xpp.getAttributeValue(null,
										"date");
								tomorrowLow = xpp
										.getAttributeValue(null, "low");
								tomorrowHigh = xpp.getAttributeValue(null,
										"high");
								tomorrowCondition = xpp.getAttributeValue(null,
										"text");
								tomorrowConditionCode = xpp.getAttributeValue(
										null, "code");
							} else if (count == 2) {

								tomorrowDay_next = xpp.getAttributeValue(null,
										"day");
								tomorrowDate_next = xpp.getAttributeValue(null,
										"date");
								tomorrowLow_next = xpp.getAttributeValue(null,
										"low");
								tomorrowHigh_next = xpp.getAttributeValue(null,
										"high");
								tomorrowCondition_next = xpp.getAttributeValue(
										null, "text");
								tomorrowConditionCode_next = xpp
										.getAttributeValue(null, "code");

								Log.v("dd", "tomorrowConditionCode_next::"
										+ tomorrowConditionCode_next);

							} else if (count == 3) {

								tomorrowDay_next2 = xpp.getAttributeValue(null,
										"day");
								tomorrowDate_next2 = xpp.getAttributeValue(
										null, "date");
								tomorrowLow_next2 = xpp.getAttributeValue(null,
										"low");
								tomorrowHigh_next2 = xpp.getAttributeValue(
										null, "high");
								tomorrowCondition_next2 = xpp
										.getAttributeValue(null, "text");
								tomorrowConditionCode_next2 = xpp
										.getAttributeValue(null, "code");

							} else if (count == 4) {

								tomorrowDay_next3 = xpp.getAttributeValue(null,
										"day");
								tomorrowDate_next3 = xpp.getAttributeValue(
										null, "date");
								tomorrowLow_next3 = xpp.getAttributeValue(null,
										"low");
								tomorrowHigh_next3 = xpp.getAttributeValue(
										null, "high");
								tomorrowCondition_next3 = xpp
										.getAttributeValue(null, "text");
								tomorrowConditionCode_next3 = xpp
										.getAttributeValue(null, "code");
