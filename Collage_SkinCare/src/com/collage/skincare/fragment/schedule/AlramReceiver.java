...
public class AlramReceiver extends BroadcastReceiver
{
	...
	private void showNotification(Context context, int statusBarlconID, String statusBarTextID, String detailedTextID)
	{
		// TODO Auto-generated method stub

		Intent contentIntent = new Intent(context, TestPageWrite.class);

		PendingIntent theappIntent = PendingIntent.getActivity(context, 0, contentIntent, PendingIntent.FLAG_CANCEL_CURRENT);
		...
		notif.sound = Uri.withAppendedPath(Audio.Media.INTERNAL_CONTENT_URI, "5");
