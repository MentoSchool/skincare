...
import com.collage.skincare.db.AreaNoDB;
import com.collage.skincare.db.DBUtils;
import com.collage.skincare.location.LocationUtils;
import com.collage.skincare.model.response.AbsResponse;
import com.collage.skincare.model.response.life.UltraViolet;
...
public class FragMain extends Fragment
{
	 ...
	 **********************************************************************************************/
	/**
	 * Invoked by the "Get Address" button. Get the address of the current location, using reverse geocoding. This only works if a geocoding service is available.
	 * 
	 * @param v
	...
	protected class GetAddressTask extends AsyncTask<Location, Void, String>
	{
		...
		protected String doInBackground(Location... params)
		{
			...
			if (addresses != null && addresses.size() > 0)
			{
				...
				/*
				 * // Format the first line of address String addressText = getString(R.string.address_output_string,
				 * 
				 * // If there's a street address, add it address.getMaxAddressLineIndex() > 0 ? address.getAddressLine(0) : "",
				 * 
	...
	private void showErrorDialog(int errorCode)
	{
		...
		Dialog errorDialog = GooglePlayServicesUtil.getErrorDialog(errorCode, mContext, LocationUtils.CONNECTION_FAILURE_RESOLUTION_REQUEST);
