...
public class FragWeatherToday extends Fragment {
	...
	private void init(View view) {
		...
		tv_select_Weather = (TextView) view
				.findViewById(R.id.tv_select_Weather);
		tv_local = (TextView) view.findViewById(R.id.tv_local);
		tv_temperature_cur = (TextView) view
				.findViewById(R.id.tv_temperature_cur);
		tv_temperature_hi = (TextView) view
				.findViewById(R.id.tv_temperature_hi);
		tv_temperature_low = (TextView) view
	...
	private void CreateDialog() {
		...
		final View innerView = getActivity().getLayoutInflater().inflate(
				R.layout.splash_surb, null);
	...
	public Handler handler = new Handler() {
		...
		private void Weather_Detail() {
			...
			calleryAdapter = new FragWeatherToday_CustemCalleryAdapter(
					getActivity());
			...
			OnItemClickListener itemClickListener = new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					switch (resourcId) {
					case 0:
						tv_today_date.setText("Date: "
								+ Yh_AsyncWeather.vo.getTodayDate());
						tv_cur_Weather.setText("현재 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
												.getCurConditionCode())]);
						tv_select_Weather.setText("오늘 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
												.getTodayConditionCode())]);
						tv_local.setText("지역:"
								+ Yh_AsyncWeather.vo.getCurLocation());
						tv_temperature_cur.setText("현재 온도:"
								+ Yh_AsyncWeather.vo.getCurTemp() + "℃");
						tv_temperature_hi.setText("최고 온도:"
								+ Yh_AsyncWeather.vo.getTodayHigh() + "℃");
						...
						Toast.makeText(getActivity(), "오늘의 날씨",
								Toast.LENGTH_SHORT).show();
						break;
					case 1:
						tv_today_date.setText("Date: "
								+ Yh_AsyncWeather.vo.getTomorrowDate());
						Toast.makeText(getActivity(), "다음의 날씨",
								Toast.LENGTH_SHORT).show();
						tv_cur_Weather.setText("현재 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
					...
					case 2:
						tv_today_date.setText("Date: "
								+ Yh_AsyncWeather.vo.getTomorrowDate_next());
						Toast.makeText(getActivity(), "다음2의 날씨",
								Toast.LENGTH_SHORT).show();
						tv_cur_Weather.setText("현재 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
					...
					case 3:
						tv_today_date.setText("Date: "
								+ Yh_AsyncWeather.vo.getTomorrowDate_next2());
						Toast.makeText(getActivity(), "다음3의 날씨",
								Toast.LENGTH_SHORT).show();
						tv_cur_Weather.setText("현재 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
					...
					case 4:
						tv_today_date.setText("Date: "
								+ Yh_AsyncWeather.vo.getTomorrowDate_next3());
						Toast.makeText(getActivity(), "다음4의 날씨",
								Toast.LENGTH_SHORT).show();
						tv_cur_Weather.setText("현재 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
					...
					case 5:
						tv_today_date.setText("Date: "
								+ Yh_AsyncWeather.vo
										.getTomorrowConditionCode_next());
						Toast.makeText(getActivity(), "다음5의 날씨",
								Toast.LENGTH_SHORT).show();
						tv_cur_Weather.setText("현재 날씨:  "
								+ weather_detail[Integer
										.parseInt(Yh_AsyncWeather.vo
