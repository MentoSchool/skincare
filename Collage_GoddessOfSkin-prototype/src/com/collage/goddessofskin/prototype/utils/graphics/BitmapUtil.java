...
public class BitmapUtil {
    ...
    /**
     * 비율을 유지 하면서 비트맵 크기 변경
     *      - 원본 비트맵의 높이가 넓이보다 큰 경우 : 지정한 높이를 기준으로 원본 비트맵 조정
     *      - 원본 비트맵의 넓이가 높이보다 큰 경우 : 지정한 넓이를 기준으로 원본 비트맵 조정
     *      
     * @param srcBitmap     원본 비트맵 소스
     * @param scaleWidth    조절할 넓이 
     * @param scaleHeight   조절할 높이
     * @return
     */
