...
public class mothed
{
	...
	public void result()
	{
		...
		dom = (30 * Integer.parseInt(sdf_h.format(new Date())) + 0.25 * Integer.parseInt(sdf_m.format(new Date())));
		dom2 = ((30 * Integer.parseInt(format_s_h)) + (0.25 * Integer.parseInt(format_s_m)));
		// 1시간에 30도 + 1분에 0.25도
		dom3 = ((30 * Integer.parseInt(format_s_hs)) + (0.25 * Integer.parseInt(format_s_ms)));
		// 1시간에 30도 + 1분에 0.25도
