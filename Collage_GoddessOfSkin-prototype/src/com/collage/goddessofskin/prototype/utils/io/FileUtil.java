package com.collage.goddessofskin.prototype.utils.io;

import com.collage.goddessofskin.prototype.utils.graphics.BitmapUtil;
...
public class FileUtil {
    ...
    {
        if (v == null || fileName == null || fileName.length() == 0)
            return null;
    ...
    public static File save(Bitmap bmp, String dirName, String fileName) {
        if (bmp == null || fileName == null || fileName.length() == 0)
            return null;
     ...
     * 
     * @param c InputStream 또는 OutputStream
     */
