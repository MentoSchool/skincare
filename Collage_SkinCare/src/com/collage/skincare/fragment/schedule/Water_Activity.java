...
public class Water_Activity extends Activity implements OnTimeChangedListener, OnDateChangedListener
{
	...
	OnItemClickListener clickListener = new OnItemClickListener()
	{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3)
		{
			...
			new AlertDialog.Builder(Water_Activity.this).setTitle("http://croute.me - 예제")
	...
	protected void setAlarm()
	{
		...
		else
		{
			...
			PendingIntent sender = PendingIntent.getBroadcast(Water_Activity.this, 0, intent, 0);
